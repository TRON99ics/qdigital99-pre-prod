...
export default function FeaturedWork() {
  ...
  return (
    <section ref={wrap} className="overflow-hidden bg-paper py-20 md:py-0">
      <div className="md:flex md:h-screen md:flex-col md:justify-center">
        ...
        <div
          ref={track}
          className="flex flex-col gap-8 px-6 md:flex-row md:gap-10 md:px-14 md:[width:max-content]"
        >
          {caseStudies.map((cs) => (
            <Link
              key={cs.id}
